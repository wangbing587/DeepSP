...
pRolocMethods <-function(data,name){
  ...
  svmparams <- svmOptimisation(data, fcol = "markers",
                                   ...
                                   class.weights = w)
  print(svmparams)
  save(svmparams, file = paste0("../data/input_rawdata/", name, '/', name, "svm.rda"))


  knnparams <- knnOptimisation(data, fcol = "markers",
                                   times = 100, xval = 5)
  print(knnparams)
  save(knnparams, file = paste0("../data/input_rawdata/", name, '/', name, "knn.rda"))
  ...
  nnetparams = nnetOptimisation(data, fcol = "markers",
                                ...
                                size = seq(1, 10, 2))
  print(nnetparams)
  save(nnetparams, file = paste0("../data/input_rawdata/", name, '/', name, "nnet.rda"))


  rfparams = rfOptimisation(data, fcol = "markers",
                                times = 100, xval = 5)
  print(rfparams)
  save(rfparams, file = paste0("../data/input_rawdata/", name, '/', name, "rf.rda"))


  nbparams = nbOptimisation(data, fcol = "markers",
                                times = 100, xval = 5)
  print(nbparams)
  save(nbparams, file = paste0("../data/input_rawdata/", name, '/', name, "nb.rda"))


  mcmcparams <- tagmMcmcCvalpar(object = data, times = 100, test.size = 0.2)
  save(mcmcparams, file = paste0("../data/input_rawdata/", name, '/', name, "mcmc.rda"))
  
  
  mapparams <- tagmMapCval(object = data, times = 100, test.size = 0.2)
  save(mapparams, file = paste0("../data/input_rawdata/", name, '/', name, "map.rda"))
}
